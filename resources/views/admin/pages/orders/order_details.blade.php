                            ...
                            <tr>
                                ...
                                <td>
                                    @if($product->pivot != null)
                                        @foreach($products_item_id as $product_item)
                                            @if($product_item->product_item_id == $product->pivot->product_item_id)
                                                @foreach($details as $detail)
                                                    @if ($detail->id == $product_item->product_detail_id)
                                                        {{$detail->name}}:
                                                    @endif
                                                @endforeach
                                                @foreach($details_value as $detail_value)
                                                    @if ($detail_value->id == $product_item->product_detail_value_id)
                                                        {{$detail_value->value}}<br>
                                                    @endif
                                                @endforeach
                                            @endif
